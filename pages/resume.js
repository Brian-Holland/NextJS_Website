			...
			<section className="pb-2 px-5">
				...
				<ul className="resume-ul">
					<li>
						...
						account, validate and authenticate logins, and store and search custom created contacts using
						full CRUD commands.<br />
					...
					<li>
						...
						: Responsive React application utilizing the GitHub API to search for GitHub user information
						and displays the API response in a custom profile component.<br />
						<strong>Deployment</strong>:
					...
					<li>
						...
						: JavaScript bot utilizing Cheerio to access the Twitter Developer API and pull a pre-written
						post from a Google Sheets document to post daily using Google Cloud Platform’s Cloud Scheduler.<br />
						<strong>Deployment</strong>:
				...
				<p>
					Managed a team of 30+ employees, responsible for day-to-day operations including customer service,
					staff training, promotion recommendations, nightly grosses, inventory control, and general theater
					operations.
				</p>
				<br />
				<h5>Education</h5>
